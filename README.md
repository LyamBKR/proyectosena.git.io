...
El proyecto está organizado en 60 páginas que cubren todos los aspectos del desarrollo de software, más una sección especial de **Investigación**:
...
6. **Investigación** (Página especial)
